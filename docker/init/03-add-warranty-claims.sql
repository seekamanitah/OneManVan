...
-- Migration: 03-add-warranty-claims.sql
-- =====================================================
...
IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_NAME = 'WarrantyClaims')
BEGIN
    PRINT 'Creating WarrantyClaims table...';
...
ELSE
BEGIN
    PRINT 'WarrantyClaims table already exists - skipping creation';
END
