...
IF NOT EXISTS (SELECT * FROM sys.tables WHERE name = 'DropdownPresets')
BEGIN
    CREATE TABLE DropdownPresets (
        Id INT IDENTITY(1,1) PRIMARY KEY,
        Category NVARCHAR(50) NOT NULL,
        DisplayValue NVARCHAR(200) NOT NULL,
        StoredValue NVARCHAR(200) NULL,
    ...
    CREATE INDEX IX_DropdownPresets_Category ON DropdownPresets(Category, IsActive, SortOrder);
END
GO
...
INSERT INTO DropdownPresets (Category, DisplayValue, SortOrder, IsSystemDefault) VALUES
...
-- Refrigerant Types
INSERT INTO DropdownPresets (Category, DisplayValue, StoredValue, SortOrder, IsSystemDefault) VALUES
...
PRINT 'DropdownPresets table created and seeded with defaults.';
GO
